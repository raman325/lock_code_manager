...
async def test_uc_shim_empty_code_pushes_empty(
    ...
    Whatever Lock Code Manager wants on the slot: with no polls and no drift
    read, this event is the only way a code deleted at the keypad or by
    another controller ever reaches the coordinator.
    """
    mock_coordinator = MagicMock()
