...
class ZHALock(BaseLock):
    ...
    def usercode_scan_interval(self) -> timedelta:
        ...
        ZHA locks don't support push updates for user codes, so we poll.
        Use a longer interval to reduce Zigbee traffic.
        """
    ...
    def hard_refresh_interval(self) -> timedelta | None:
        ...
        Since we can't subscribe to user code changes, periodic refresh
