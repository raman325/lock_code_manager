...
## Generated Files to Exclude from Review

**IMPORTANT:** Do not review or modify these generated/built files:

- `custom_components/lock_code_manager/www/lock-code-manager-strategy.js`
  - Generated by Rollup from TypeScript source in `ts/` directory
  - Marked as `linguist-generated=true` in `.gitattributes`
  - **Review the TypeScript source files in `ts/` instead**

See `.github/copilot-instructions.md` for detailed exclusion guidance.
